            ...
            <div class="container mx-auto w_1000">
                ...
                <?php foreach($topTutorials as $tutorial) {
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="card text-center r_30 shadow border-0 hs_11 trans_2_eio">
                            <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="category-list text-center pb_20x">
                            ...
                            ?>
                                <a href="<?php echo get_term_link($term); ?>" class="btn r_25 px_40 mx_5 py_10_10 btn-primary "><?php echo $term->name; ?></a>
                            <?php } ?>
                        </div>
